            ...
            <div class="tz-slider-banner">
                <div class="tz-items">
                    ...
                    <div class="tz-banner-content">
                        ...
                        <marquee style="font-family: Arial; font-size:15px; color:#FFFAF0;"><strong> ..... PANDUAN PENGISIAN FORMULIR ONLINE.  Regristasi Terlebih Dahulu Klik Menu MENDAFTAR, Setelah Itu Melengkapi Data Diri Klik Menu LOGIN .....</strong></marquee>
                    </div>
                </div>
            </div>
        </div>
