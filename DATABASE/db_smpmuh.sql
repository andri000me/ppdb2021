...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2021 at 02:33 PM
...
-- Database: `db_smpmuh`
--
CREATE DATABASE IF NOT EXISTS `db_smpmuh` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_smpmuh`;
...
(1, 'Admin PPDB', '1234567890', 'admin', 'e9fd363bedc114628fe2cdce1493db15', 'Admin'),
...
CREATE TABLE IF NOT EXISTS `tb_bls_pesan` (
  `id_bls_pesan` int(5) NOT NULL AUTO_INCREMENT,
  `id_admin` int(5) NOT NULL,
  `id_pesan` int(5) NOT NULL,
  `status` text NOT NULL,
  `pesan` text NOT NULL,
  `tgl_konfirmasi` datetime NOT NULL,
  PRIMARY KEY (`id_bls_pesan`)
...
CREATE TABLE IF NOT EXISTS `tb_catatan_kepsek` (
  `id_catatan_kepsek` int(5) NOT NULL AUTO_INCREMENT,
  `id_admin` int(5) NOT NULL,
  `catatan` text NOT NULL,
  `tgl_entry` datetime NOT NULL,
  PRIMARY KEY (`id_catatan_kepsek`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `tb_konfirmasi_pendaftaran` (
  `id_konfirmasi_pendaftaran` int(5) NOT NULL AUTO_INCREMENT,
  `id_admin` int(5) NOT NULL,
  `id_siswa` int(5) NOT NULL,
  `status` text NOT NULL,
  `pesan` text NOT NULL,
  `tgl_konfirmasi` datetime NOT NULL,
  PRIMARY KEY (`id_konfirmasi_pendaftaran`)
...
(40, 'PPDB21-001', 'KANAYA ANGGITA MAHARANI', '234', 'YOGYAKARTA', '2008-01-20', '2', 'Islam', '1', '2', 'Anak Kandung', 'GUNUNGKETUR', '23456', 'SD N BALIREJO', '-', 'BALIREJO', '2021', '345', 'BABE', 'NUBI', 'BANTUL', '890', 'Peg. Swasta', 'Ibu Rumah Tangga', 'AAN', 'BANTUL', '678', 'Wiraswasta', '', '', '250', 'kanaya', 'Regular', 'kanaya', 'a8760058726188d1418b79ba46470559', '2021-01-29 11:12:48', '2021-01-29 11:33:06', 'Baru', 'Siswa', 1, '', 85, 90, 75, 'Bantul', '', 'GUNUNGKETUR', 'BANTUL', 'B'),
